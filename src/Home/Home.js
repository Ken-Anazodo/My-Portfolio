...
import IntroContinue from './IntroContinue/IntroContinue';
...
const Home = () => {
  ...
  const blackIntro = useRef(null);
  const panels = useRef(null);

   // Intro Cover Section
   useEffect(() => {
    const clanIntroBlack = blackIntro.current
    const clanIntroChildBlack = clanIntroBlack.children[0];
    ...
    const panelChildren = elPanels.getElementsByClassName('panel');
      ...
      tl41.fromTo(clanIntroBlack, { yPercent: 0, translate: 0, display: "block"}, {display: "none", yPercent: 100, translate: '100%', transition: 1, ease: 'power4.easeOut', duration: 1.5,}, '1.5')
          .fromTo(clanIntroChildBlack, { yPercent: 0, translate: 0, display: "block"}, {display: "none", yPercent: 100, translate: '-100%', transition: 1, ease: 'power4.easeOut', duration: 1.5}, '1.5')
        ...
        <div ref={panels}>
          ...
          <div className='w-[100vw] h-[100%] relative bg-black'>
            ...
            <Barcode/>  
                   ...
                   <div className='w-[100%] h-[100vh] translate-x-0 translate-y-ful absolute top-0' ref={blackIntro}>
                      <div className='w-full h-[100vh]  translate-x-0 translate-y-ful absolute top-0'>
                         <BlackIntro/>
                      </div>
                   </div>
