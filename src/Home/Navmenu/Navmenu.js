    ...
    <div>
        ...
        <div className='nav px-7 mb-[2.5vw] xl:mb-[3vw] 2xl:mb-[2vw] mx-auto flex flex-col-reverse sm:flex-row justify-around space-x-4 text-stone-300' ref = {navSelect}>
            <div className='flex items-center cursor-pointer'>
              <div className='ttoc text-zinc-500 sm:text-stone-300  text-[3.7vw] sm:text-[1.5vw]'><h1>The Clan Chief</h1></div>
              <img className='h-[2.2vw] w-[2.2vw] sm:w-[1.3vw] sm:h-[1.3vw] ml-[0.5vw] object-cover' src= {ceee} alt= "copyright"></img>
            </div>
            <div className='ttoc flex items-center inTouch delay-100 text-[20px] sm:text-[1.5vw] xl:hover:text-[2.4vw] text-stone-300 cursor-pointer flex justify-end sm:block mb-9 sm:mb-0'>
              ...
              <Link to="/GetInTouch">
                <button><h1 className='text-stone-400 sm:text-red-600 hover:text-zinc-700 lg:hover:text-stone-500 '>GET IN TOUCH</h1></button>
                </Link>
              </div>
        </div>
