...
useEffect(() => {
    ...
    let tl00 = gsap.timeline({
        ...
        tl00.fromTo(picFolderChild, {opacity:0, y: '100vw'}, {opacity:1, y: 0, duration: 2, transition: 1, stagger: 0.5, ease: "power4.easeIn"}, "0.5")
            .fromTo(tBranding, {opacity:0, x: '30vw'}, {opacity:1, x: 0, duration: 0.4, ease: "power4.easeOut"}, "4.2")
}, [])
  ...
  return (
    <div className=' w-screen h-[100vh] relative'>
        <div className=' bg-yellow-800 w-full h-[100vh] flex justify-center items-center p-[3vw]'>
            <div ref={picFolder}>

                <div className='clanPic  h-[27vw] w-[25vw]  sm:h-[17vw] sm:w-[16vw] md:h-[14vw] md:w-[13vw] lg:h-[12vw] lg:w-[11vw] -skew-y-6 mb-[1vw]'>
                    <img className='object-cover w-full h-full' src= {p1} alt= "Pic"></img>
                </div>

                <div className='clanPic  h-[27vw] w-[25vw]  sm:h-[17vw] sm:w-[16vw] md:h-[14vw] md:w-[13vw] lg:h-[12vw] lg:w-[11vw] skew-y-6 mb-[1vw]'>
                    <img className='object-cover w-full h-full' src= {p2} alt= "Pic"></img>
                </div>

                <div className='clanPic  h-[27vw] w-[25vw]  sm:h-[17vw] sm:w-[16vw] md:h-[14vw] md:w-[13vw] lg:h-[12vw] lg:w-[11vw] -skew-y-6 mb-[1vw]'>
                    <img className='object-cover w-full h-full' src= {p3} alt= "Pic"></img>
                </div>

                <div className='clanPic  h-[27vw] w-[25vw]  sm:h-[17vw] sm:w-[16vw] md:h-[14vw] md:w-[13vw] lg:h-[12vw] lg:w-[11vw] skew-y-6'>
                    <img className='object-cover w-full h-full' src= {p4} alt= "Pic"></img>
                </div>

            </div>


                <div className='absolute bottom-[9vw] lg:bottom-[3vw] right-[3vw]' ref={tBrand}>
